...
export default function InventarioHeader({
  ...
  subtitle = 'Gestión profesional de productos',
  backTo = '/dashboard'
}) {
  ...
  return (
    <header className="bg-gradient-to-r from-slate-800 via-slate-900 to-indigo-900 relative overflow-hidden rounded-2xl mb-6 sm:mb-8 shadow-xl">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="hidden lg:block absolute top-1/2 left-1/2 w-32 h-32 bg-purple-500/5 rounded-full -translate-x-16 -translate-y-16" />
      </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="w-full sm:w-auto flex items-center">
            <button
              ...
              className="flex items-center gap-2 text-slate-200 hover:text-white transition-all duration-150 rounded-md px-2 py-1 sm:px-3 sm:py-2 bg-white/0 hover:bg-white/5"
            >
          ...
          <div className="w-full sm:w-auto flex items-center justify-end gap-3">
            <div className="hidden sm:flex flex-col items-end text-right">
              ...
              <div className="text-xs text-slate-300">Inventario Profesional</div>
            </div>
