...
export default function InventarioHeader({ title = 'Sistema de Inventario', subtitle = 'Gestión profesional de productos', backTo = '/dashboard' }) {
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-center gap-4 mb-3">
              <div className="p-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl shadow-lg">
                <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M7.5 4.21L12 6.81l4.5-2.6M12 6.81V17.69" stroke="currentColor" strokeWidth="1.5"/>
                </svg>
              </div>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <div className="text-sm text-slate-300">Inventario Profesional</div>
            </div>
