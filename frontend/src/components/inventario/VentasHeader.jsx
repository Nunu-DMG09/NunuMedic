  ...
  return (
    <header className="bg-gradient-to-r from-slate-800 via-slate-900 to-indigo-900 relative overflow-hidden rounded-2xl mb-8 shadow-xl">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-64 h-64 bg-emerald-500/10 rounded-full -translate-y-32"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-green-500/10 rounded-full translate-y-48"></div>
        <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-teal-500/5 rounded-full -translate-x-16 -translate-y-16"></div>
      </div>
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-center gap-4 mb-3">
              <div className="p-3 bg-gradient-to-r from-emerald-500 to-green-600 rounded-2xl shadow-lg">
                <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="none">
                  <path d="M3 3v5h5M3.05 13A9 9 0 1 0 6 5.3L3 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <div className="text-sm text-slate-300">Sistema de Ventas</div>
            </div>
