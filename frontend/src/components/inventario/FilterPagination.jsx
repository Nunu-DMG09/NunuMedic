      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-3">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-2">
            <button
              onClick={onClear}
              className="flex-1 px-3 py-2 bg-blue-50 text-blue-800 border-2 border-blue-100 rounded-md hover:bg-blue-100 transition cursor-pointer"
            >
              Limpiar
            </button>
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={page <= 1}
                className="px-3 py-2 bg-blue-50 text-blue-800 border-2 border-blue-100 rounded-md hover:bg-blue-100 transition cursor-pointer disabled:opacity-50"
